package com.inhandplus.basicscodelab
...
import com.inhandplus.basicscodelab.ui.theme.BasicsCodelabTheme
...
@Preview(showBackground = true, name = "Preview", widthDp = 320)
@Composable
fun DefaultPreview() {
    BasicsCodelabTheme {
        MyApp()
